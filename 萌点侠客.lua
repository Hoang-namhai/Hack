...
gg.alert("☛Đợi Đến Giây Thứ 5 Rồi Mới Bật☚\n☛Đợi Nó Load Xong Báo ✅Activated✅ Là Hack Thành Công Nhé☚")
...
r=searchValue({"5~6",{"4201",7*4},{"30",29*4}},gg.REGION_ANONYMOUS,gg.TYPE_DWORD)
if #r == 0 then else
searchEdit(0*4,4, 290)
gg.clearResults()
gg.alert('✅Activated✅')
stopClose()
end
