...
if info == "net.cravemob.zeus" then 
else
...
gg.getTargetInfo()
gg.alert("𝙶𝙰𝙼𝙴 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 : 1.47.1                                                                                                                            𝙶𝙰𝙼𝙴 𝙽𝙰𝙼𝙴 : Revenger Saga IDLE RPG 𝚇64                                                                                                                 𝚂𝙲𝚁𝙸𝙿𝚃 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 : 1.0                                                                                                                                 𝙻𝙰𝚂𝚃 𝚄𝙿𝙳𝙰𝚃𝙴 : 𝚂𝚊𝚝𝚞𝚛𝚍𝚊𝚢, 𝙹𝚞𝚕𝚢 𝟸0, 𝟸0𝟸𝟺                                                                                                  Mᴀᴅᴇ Bʏ Hᴏᴀ̀ɴɢ Nᴀᴍ Hᴀ̉ɪ                                                                                                                                Sᴄʀɪᴘᴛ Pᴜʙʟɪsʜᴇᴅ ɪɴ ©2024", "[𝙽𝙴𝚇𝚃]")
...
"➣ No Ads 💢",
"[Exɪᴛ]"
}, nil,"❤Yᴏᴜᴛᴜʙᴇ :: ʜᴀ̉ɪ sᴄʀɪᴘᴛ🍀\n🎮Game: Revenger Saga IDLE RPG X64\n💭Version: 1.47.1\n--------------------------------------------------------------\n")
if bmenu == nil then
goto ni
end
if bmenu[1] then
...
HNH=nil  HNH={}
HNH[1]={}
HNH[1].address=HNHH+0x35184A8+0
HNH[1].value='D2800020h'
HNH[1].flags=4
HNH[2]={}
HNH[2].address=HNHH+0x35184A8+4
...
HNH=nil  HNH={}
HNH[1]={}
HNH[1].address=HNHH+0x2B63644+0
HNH[1].value='D2800020h'
HNH[1].flags=4
HNH[2]={}
HNH[2].address=HNHH+0x2B63644+4
HNH[2].value='D65F03C0h'
HNH[2].flags=4
gg.setValues(HNH)
gg.toast('✅Activated✅')
