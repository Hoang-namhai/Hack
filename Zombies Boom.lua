...
gg.getTargetInfo()
gg.alert("𝙶𝙰𝙼𝙴 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 : 1.37                                                                                                                            𝙶𝙰𝙼𝙴 𝙽𝙰𝙼𝙴 : Zombies Boom 𝚇64                                                                                                                 𝚂𝙲𝚁𝙸𝙿𝚃 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 : 1.0                                                                                                                                 𝙻𝙰𝚂𝚃 𝚄𝙿𝙳𝙰𝚃𝙴 : 𝚂𝚊𝚝𝚞𝚛𝚍𝚊𝚢, 𝙹𝚞𝚕𝚢 𝟸0, 𝟸0𝟸𝟺                                                                                                  Mᴀᴅᴇ Bʏ Hᴏᴀ̀ɴɢ Nᴀᴍ Hᴀ̉ɪ                                                                                                                                Sᴄʀɪᴘᴛ Pᴜʙʟɪsʜᴇᴅ ɪɴ ©2024", "[𝙽𝙴𝚇𝚃]")
...
function BuffExp()
local menu = gg.alert('🅜🅔🅝🅤 ​ 🅑🅤🅕🅕 ​ 🅔🅧🅟 ​ 🅥🅘🅟\n❤Yᴏᴜᴛᴜʙᴇ :: ʜᴀ̉ɪ sᴄʀɪᴘᴛ🍀\n--------------------------------------------------------------\n\n- Function Mod:\n- Buff Exp 💨\n\n- Lưu Ý:\n- Chức Năng Này Vào Trận Mới Bật...\n- Mỗi Trận Bật 1 Lần...', '๑ACTIVATE๑')
if menu == 0 then 
elseif 
menu == 1 then
valueFromClass("ActorData", "0xAC", true, false, gg.TYPE_DWORD)
gg.getResults(9999)
...
function OneHit()
local menu = gg.alert('🅜🅔🅝🅤 ​ 🅑🅤🅕🅕 ​ 🅔🅧🅟 ​ 🅥🅘🅟\n❤Yᴏᴜᴛᴜʙᴇ :: ʜᴀ̉ɪ sᴄʀɪᴘᴛ🍀\n--------------------------------------------------------------\n\n- Function Mod:\n- One Hit 💥\n\n- Lưu Ý:\n- Hãy Load 1 Trận Đấu Rồi Thoát Ra Sảnh Để Bật...\n- Các Trận Sau Không Cần Bật Lại...', '๑ACTIVATE๑')
if menu == 0 then 
elseif 
menu == 1 then
...
function SkillVip()
local menu = gg.alert('🅜🅔🅝🅤 ​ 🅑🅤🅕🅕 ​ 🅔🅧🅟 ​ 🅥🅘🅟\n❤Yᴏᴜᴛᴜʙᴇ :: ʜᴀ̉ɪ sᴄʀɪᴘᴛ🍀\n--------------------------------------------------------------\n\n- Function Mod:\n- Skill Vip 💢\n\n- Lưu Ý:\n- Khi Nào Có Skill Như Đạn Băng, Xe, Tia Sét V.v Mới Bật Chức Năng Này...\n- Mỗi Trận Bật 1 Lần...', '๑ACTIVATE๑')
if menu == 0 then 
elseif 
menu == 1 then
