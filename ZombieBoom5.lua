...
if HNHH == 1 then ONHackTime() end
if HNHH == 2 then OneHitGodMod() end
...
local HNH = gg.alert('❤Yᴏᴜᴛᴜʙᴇ :: ʜᴀ̉ɪ sᴄʀɪᴘᴛ🍀\n--------------------------------------------\n\n➣ 𝙵𝚄𝙽𝙲𝚃𝙸𝙾𝙽 𝙼𝙾𝙳:\n[™𝙾𝙽𝙴𝙷𝙸𝚃+𝙶𝙾𝙳𝙼𝙾𝙳™] ❤️\n\n➣ Lưu Ý:\n➣ Hãy Vào 1 Trận Đấu Bất Kỳ Tùy Theo Chế Độ Chơi.\n➣ Vào Trong Trận Và Bật Hack Xong Hãy Thoát Ra Sảnh Nhé.\n➣ Thoát Ra Tới Sảnh Vào Trận Mới Là Ok.\n➣ Chức Năng Này Chỉ Cần Bật 1 Lần Là Được.\n➣ Các Trận Sau Không Cần Bật Nữa.','[𝙶𝙾𝙳𝙼𝙾𝙳]','[𝙾𝙽𝙴𝙷𝙸𝚃]')
if HNH == nil then return 
else
if HNH == 2 then ONEHIT() end
if HNH == 1 then GODMOD() end
end
::ni::
end
