...
gg.setValues(tt)
 ...
 r=searchValue({" 1072519184",{"1649267442",-1*4},{"1071749529",-2*4},},gg.REGION_C_ALLOC,gg.TYPE_DWORD)
if #r == 0 then else
searchEdit(-6*4,4, - 1054972314)
gg.clearResults()
