...
gg.clearResults()
gg.clearList()
gg.searchNumber("h3333333333164098F8FAA2", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)
gg.refineNumber("-104", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)
...
for i, v in ipairs(t) do
	v.address = v.address + 0xffffffffffffffd7
